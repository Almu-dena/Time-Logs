...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.resize(410, 804)
        Form.setMinimumSize(QSize(410, 804))
        palette = QPalette()
        ...
        Form.setStyleSheet(u"background-color: rgb(80, 80, 80);")
...
"color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(QCoreApplication.translate("Form", u"Person", None))
        self.label_3.setText(QCoreApplication.translate("Form", u"Make sure to put your Shotgrid name or user.", None))
        self.label_4.setText(QCoreApplication.translate("Form", u"Task", None))
        self.label_5.setText(QCoreApplication.translate("Form", u"Ideally, the task that is related to your timestamp.", None))
        self.label_6.setText(QCoreApplication.translate("Form", u"Duration", None))
        self.spinBox.setSuffix(QCoreApplication.translate("Form", u" minutes", None))
        self.label_7.setText(QCoreApplication.translate("Form", u"Category", None))
        self.label_9.setText(QCoreApplication.translate("Form", u"Select the category that most closely describes the nature of your timestamp.", None))
        self.label_8.setText(QCoreApplication.translate("Form", u"Description", None))
        self.label_2.setText(QCoreApplication.translate("Form", u"Optional text for specific description.", None))
        self.pushButton_2.setText(QCoreApplication.translate("Form", u"Cancel", None))
        self.pushButton.setText(QCoreApplication.translate("Form", u"Create Time Log", None))
    # retranslateUi
